...
export default function AgentOrbit() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-24 glass-panel border-t border-[rgba(255,255,255,0.08)] flex items-center justify-between px-8 z-40">
      ...
      <button className="flex items-center gap-2 bg-[#00f3ff]/10 hover:bg-[#00f3ff]/20 text-[#00f3ff] border border-[#00f3ff]/30 px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-widest transition-all hover:shadow-[0_0_20px_rgba(0,243,255,0.2)]">
